                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="modal-footer">
                            ...
                            <button   disabled={note2.etitle.length<5 || note2.edescription.length<5}  onClick={handleClick} type="button" className="btn btn-primary">Update Note</button>
                        </div>
                    </div>
                </div>
            </div>
...
export default Note
//disabled={note2.etitle.length<5 || note2.edescription.length<5}